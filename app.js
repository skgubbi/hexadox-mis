...
const supabaseKey =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV1eXF2aXNxZ3h1d3pjc3d3aXFpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY4NDY3OTIsImV4cCI6MjEwMjQyMjc5Mn0.9QjLUxFdiy-D92hImFtLuPcLQ81b47YK9PgyfwgjELc";
        ...
        const render = () => {
            ...
            (async()=>{
                try{
                    ...
                    const ensure=(hq,p,m)=>{const k=String(hq)+"|"+String(m)+"|"+String(p);if(!groups.has(k))groups.set(k,{hqId:hq,month:m,productId:p,targetUnits:0,targetValue:0,primaryUnits:0,primaryValue:0,secondaryUnits:0,secondaryValue:0});return groups.get(k);};
                    ...
                    const n=v=>(Number(v)||0).toLocaleString("en-IN",{maximumFractionDigits:2}), money=v=>(Number(v)||0).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2}), pct=(a,t)=>(Number(t)>0?Number(a)/Number(t)*100:0).toLocaleString("en-IN",{minimumFractionDigits:1,maximumFractionDigits:1})+"%";
